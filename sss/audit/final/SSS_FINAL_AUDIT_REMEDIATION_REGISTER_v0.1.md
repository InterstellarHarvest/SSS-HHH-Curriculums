...
| # | Case | Status | Record |
|---:|---|---|---|
| 1 | C1 Case 01 — ISS Greenhouse | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE01_v0.1.md` |
| 2 | C1 Case 02 — Lunar Greenhouse | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE02_v0.1.md` |
| 3 | C1 Case 03 — Mars Habitat | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE03_v0.1.md` |
| 4 | C1 Case 04 — Hayes Orbital Station | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE04_v0.1.md` |
| 5 | C1 Case 05 — Sub Surface Bunker | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE05_v0.1.md` |
| 6 | C1 Case 06 — First Contact Protocol | `OWNER_ACCEPTED` | `SSS_FINAL_AUDIT_C1_CASE06_v0.1.md` |
...
## Major findings
- `C1C1-T01` Teacher procedure skips Task 5
- `C1C1-AK01` Answer Key Task 3 omits O/I fields
- `C1C1-ACC01` Accessible insufficiently hand-holding
- `C1C2-T01` Teacher template drift
- `C1C2-T02` full analytic rubric missing
- `C1C2-ACC01` Accessible insufficiently hand-holding
- `C1C3-T01` Teacher template drift / 8 pages
- `C1C3-T02` Teacher procedure skips Tasks 4–5
- `C1C3-T03` full analytic rubric missing
- `C1C3-UI01` required diagnosis selection not digitally persisted
- `C1C4-T01` Teacher template drift
- `C1C4-T02` Teacher source list absent
- `C1C4-T03` common rubric system absent
- `C1C4-UI01` required diagnosis selection not digitally persisted
- `C1C5-T01` Teacher template drift / 8 pages
- `C1C5-T02` procedure explicitly covers only Tasks 3,5,7
- `C1C5-T03` full analytic rubric missing
- `C1C5-UI01` best diagnosis not digitally persisted
- `C1C6-T01` Teacher template drift / 8 pages
- `C1C6-T02` rubric contract mismatch
- `C1C6-UI01` best diagnosis not digitally persisted
- `C1C7-T01` Teacher template drift / 8 pages
- `C1C7-UI01` best diagnosis not digitally persisted
...
## Moderate findings
- `C1C1-GS01` rendered grayscale tint
- `C1C2-T03` runtime clue IDs visible
- `C1C3-AK01` Task 4 key lacks visible field correspondence
- `C1C3-AK02` accepted-alternative guidance too thin
- `C1C3-ACC01` targeted Accessible refinement
- `C1C3-DATA01` `700 nm+` boundary ambiguity
- `C1C3-T04` production/release material in Teacher Guide
- `C1C4-T04` runtime clue IDs visible
- `C1C4-T05` wrong Accessible page count
- `C1C4-ACC01` Accessible Tasks 5/7 refinement
- `C1C5-T04` internal game-node paths printed
- `C1C5-ACC01` Accessible Task 5 partial completion needed
- `C1C5-ID01` curriculum/game location identity drift
- `C1C6-ACC01` diagnosis/intervention workload needs partial scaffolding
- `C1C7-T02` Teacher pacing order conflicts with registry order
...
## Minor findings
- `C1C2-META01` wrong Accessible resize label
- `C1C2-META02` package identity metadata drift
- `C1C3-META01` stale/misleading resize labels
- `C1C3-META02` package identity metadata drift

All minor findings: `OPEN`.

## Shared-system gaps
- `C1C1-SYS01` cross-role task/key completeness validation
- `C1C3-SYS01` persistent fill-mode representation for every required learner action
...
- C1C2: Teacher task coverage, Answer Key, game parity, Accessible CER, grayscale
