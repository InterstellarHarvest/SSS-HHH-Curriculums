...
**Version:** 0.2 — required evidence routes, classroom timing, misconception analysis, science verification, and NGSS candidate mapping  
...
**Status:** Second substantial audit pass. The complete case architecture, direct evidence routes, likely classroom timing, distractor logic, curriculum opportunities, serious science issues, and candidate NGSS alignments are now mapped. This remains an audit—not the lesson-plan package.
...
# 12. NGSS candidate map

The alignment is strongest when lessons assess a product created around gameplay. Merely completing a case does not demonstrate a full performance expectation. The recurring strengths are the Science and Engineering Practices of analyzing information, constructing explanations, arguing from evidence, developing models, defining problems, and evaluating solutions.

| Case | Strongest practice/product | Candidate PE or component | Alignment caution |
|---|---|---|---|
| C1-1 | Evidence-based explanation or root-guide criteria | MS-ETS1-1; Cause and Effect | Gravitropism itself is not a standalone middle-school PE. |
| C1-2 | Process model and solution comparison | MS-ETS1-2; Structure and Function | Do not claim a full reproduction PE solely from tomato pollination. |
| C1-3 | Spectrum/data comparison | MS-LS1-6 support; MS-ETS1-2 | MS-LS1-6 assesses matter/energy, not POR biochemistry. |
| C1-4 | Timeline/data analysis and reactor redesign | MS-ETS1-2 | Use corrected reactor-specific science. |
| C1-5 | Argument from multiple evidence sources; shielding criteria | MS-ETS1-1/2 | Exact Europa radiation scenario is fictional. |
| C1-6 | Systems model of an environmental intervention | MS-LS2-4 support; MS-ETS1-2 | Alien evidence cannot serve as empirical Earth ecosystem evidence. |
| C1-7 | Explanation and solution evaluation | MS-ETS1-2 | Germination mechanism is fictional. |
| C2-1 | Gradient model and design-constraint analysis | MS-ETS1-1/2; Scale and Proportion | Formal rotational mathematics should be optional for middle school. |
| C2-2 | Failed-solution evaluation | MS-ETS1-2; Structure and Function | Earth buzz pollination supports the analogy; alien mechanism remains fiction. |
| C2-3 | Action-spectrum analysis | MS-LS1-6 support; MS-ETS1-2 | Assess energy capture concept, not memorization of alien pigments. |
| C2-4 | Multi-cause explanatory model | Patterns; Cause and Effect | Best used as SEP/CCC alignment rather than a full DCI claim. |
| C2-5 | Policy assumption audit and constrained solution | MS-ETS1-1/2 | Radiation dependence is fictional; evidence evaluation is the assessed practice. |
| C2-6 | Ecosystem model and restoration-solution evaluation | MS-LS2-3, MS-LS2-5, MS-ETS1-2 | Use qualified mycorrhizal claims and explicitly evaluate uncertainty. |

### Campaign assessment alignment

- **Pre-assessment:** interpret a short unfamiliar plant-failure scenario and identify what additional evidence is needed.
- **Campaign 1 culmination:** construct an explanation and evaluate solutions for C1-7 using evidence from multiple channels.
- **Campaign 2 culmination:** evaluate a restoration/policy solution in C2-6, including scientific uncertainty and constraints.
- **Final SSS synthesis/post-assessment:** diagnose two unseen scenarios, explain the mechanism, and identify one limitation in the available evidence.
...
# 16. Audit status and remaining work before phase transition

Version 0.2 completes the major structural and instructional questions needed to begin designing the curriculum architecture. One focused audit pass remains before declaring the audit final:

1. Produce exact, line-specific replacement text for the serious science edits listed in Section 11.
2. Verify any remaining historical/engineering fun facts that will appear in teacher or student materials.
3. Convert the candidate NGSS map into a final standards table with SEP, DCI, CCC, assessed student product, and explicit limitations.
4. Create the final case inventory showing canonical campaign titles/numbering once the owner chooses them.
5. Reconcile v0.2 against the updated source files after all approved science edits are committed.

No additional broad code audit is required. The remaining work is editorial, scientific, and curricular.

**Thinking setting:** remain on **High** for the final audit pass. Before moving to the Curriculum Blueprint, stop and change the recommendation to **Medium**, then obtain owner confirmation as requested.
