...
2. Read the Change Record and the Signalling Readings
3. Read the Daily Signalling Profile
...
that a function was timed, and only the within-cycle record can.
...
- no figure may draw a curve, join the reported hour blocks, or supply a value for an hour block the
  records mark as not separately reported.
