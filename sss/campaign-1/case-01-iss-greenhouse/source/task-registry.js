 ...
 * headings, source Markdown, and regression tests must use these exact
...
export const TASKS = Object.freeze([
  ...
  Object.freeze({ id: 3, slug: "investigate-four-evidence-sources", title: "Investigate four evidence sources", keyable: true, answerKeyParts: Object.freeze(["accepted-evidence"]) }),
  Object.freeze({ id: 4, slug: "test-the-competing-explanations", title: "Test the competing explanations", keyable: true, answerKeyParts: Object.freeze(["competing-explanations"]) }),
  Object.freeze({ id: 5, slug: "build-the-mechanism", title: "Build the mechanism", keyable: true, answerKeyParts: Object.freeze(["mechanism-model"]) }),
  ...
  Object.freeze({ id: 8, slug: "supply-a-consistent-orientation-cue", title: "Supply a consistent orientation cue", keyable: true, answerKeyParts: Object.freeze(["engineering-response"]) }),
