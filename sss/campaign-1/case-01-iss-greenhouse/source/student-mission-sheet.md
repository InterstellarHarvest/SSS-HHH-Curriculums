# Student Mission Sheet — ISS Greenhouse Module
...
Record only evidence that helps support or reject a cause. Mark each entry as observation/data or inference/explanation.
...
For each explanation, mark **Supported**, **Weakened**, or **Not enough evidence**, then give one evidence-based reason.
...
- Earth gravity → statoliths ______ → consistent direction signal → roots grow ______
- Microgravity → statoliths do not ______ consistently → unreliable direction signal → roots ______

## 6 · Diagnose and reject an alternative

**Diagnosis:** State the cause in your own words. Use the environmental condition and the plant mechanism.

**Rejected alternative:** Name the most tempting alternative and the evidence that weakens it.

## 7 · Claim-Evidence-Reasoning

**Claim:** What caused the crop problem?

**Evidence:** Use two or three specific pieces of evidence from more than one source.

**Reasoning:** Explain how the evidence and the gravitropism mechanism support the claim.

## 8 · Supply a consistent orientation cue

Choose or design a system that gives roots a consistent cue. Options may include root channels or mesh, a moisture gradient, shoot lighting plus a root-specific guide, a rotating chamber, or another justified design.

- **Design:**
- **One criterion:** What must the design accomplish?
- **One constraint:** What limit must the design work within?
