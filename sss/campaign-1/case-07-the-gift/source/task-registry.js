window.SSS_CASE07_TASK_REGISTRY = {
  ...
  "tasks": [
    ...
    },
    {
      ...
      "answerScope": "Liaison, Biomonitors, Specimen, and Archives must converge; 12 of 847 is about 1.4%, not proof that every missing identifier matters.",
    ...
    },
    {
      ...
      "responseType": "six-stage systems organizer plus causal explanation",
    ...
    },
    {
      ...
      "responseType": "three-option decision matrix, recommendation, monitoring plan, and prediction",
    ...
    },
    {
      ...
      "instructionalPurpose": "Campaign 1 synthesis, transfer, and independent exit ticket.",
      "provenance": ["C07 reachable", "C06 labeled", "Curriculum-created model"],
      "responseType": "campaign comparison and independent constructed response",
  ...
  "conditionLedger": {
    ...
    "traceIdentifiers": {"lab": 12, "livingAreaMinimum": 847, "coveragePercent": 1.4167650531286895, "displayPercent": 1.4},
