...
The balanced-fill review also measures the reserve beneath the final content element on every Student and Accessible page. Student reserves are 61.5, 101.0, 120.2, and 108.3 CSS pixels; Accessible reserves are 165.8, 168.2, 140.3, 152.7, 71.6, and 164.0 CSS pixels. All remain inside the enforced 40–180 pixel band, preserving writable space and deliberate separation without overflow.
