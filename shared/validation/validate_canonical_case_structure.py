...
NATIVE_NO_RECOVERY = {
    ...
    "case-07": "NOT_APPLICABLE: Case 07 was produced natively under the canonical source model; no generated release artifacts exist.",
}
    ...
    for case in cases:
        ...
        if released:
            ...
            expected_approval_record = {
                ...
                "case-07": "CASE07_OWNER_APPROVAL_v1.0.md",
            }.get(case.name[:7])
