...
For SSS Campaign 1 Cases 01–03, the central Curriculum Editor is the canonical active interface and each registered current package is the canonical active editable production source. Launch with `python3 apps/curriculum-editor/serve.py`, then open <http://127.0.0.1:8000/apps/curriculum-editor/>. Versions are not selected in the primary case menu.
