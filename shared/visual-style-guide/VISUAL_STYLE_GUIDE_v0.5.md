# VISUAL_STYLE_GUIDE_v0.5

> **Repository Draft**  
> **Projects:** *Space Sprout Sleuth* (SSS) and *Hunger, Harvest, & History* (HHH)  
> **Status:** v0.5 — Component Library, Instructional Blocks, Tables, Response Areas, and Teacher Notes  
> **Supersedes:** `VISUAL_STYLE_GUIDE_v0.4.md`  
> **Decision records:** `decision-labs/v0.3/VISUAL_STYLE_GUIDE_v0.3_DECISIONS.md`, `decision-labs/v0.4/VISUAL_STYLE_GUIDE_v0.4_DECISIONS.md`, and `decision-labs/v0.5/VISUAL_STYLE_GUIDE_v0.5_DECISIONS.md`  
> **Next planned revision:** v0.6 — Diagram language, data visualization, maps, timelines, and figure standards
...
| Primary use | Establish the shared visual system and the exact standards for typography, color, icons, page architecture, instructional components, tables, response areas, callouts, and teacher notes |
...
| Current maturity | Institutional identity, typography, grayscale, accent palettes, icons, page architecture, margins, headers, footers, section headings, callouts, response areas, tables, teacher notes, and evidence-layout families are locked; diagram and asset systems remain in development |
...
Version 0.5 carries forward all approved v0.4 standards and locks the reusable component system used across SSS and HHH curriculum documents.

The following project-defining component choices are approved:

- **Ordinary section heading:** Technical label heading
- **Priority callout:** left rule with pale field
- **Ordinary response area:** prompt above a blank bordered box
- **Ordinary student table:** ruled technical table
- **Teacher note:** neutral side stripe
- **Component corners:** 3 px technical rounding
- **Panel philosophy:** selective use rather than card-based page construction
- **Evidence structures:** multiple approved layout families selected by instructional function

The v0.5 decision was reviewed primarily in the SSS student-page context. The same shared component geometry applies to HHH and teacher-facing documents, with institutional color and content-role adjustments.

This revision defines:

- technical-label heading anatomy;
- callout hierarchy and semantic variants;
- blank response-box size families;
- student and teacher table rules;
- teacher-note treatments;
- corner geometry;
- evidence-layout families;
- panel-selection rules;
- component spacing and interaction;
- print, grayscale, and photocopy requirements;
- component CSS tokens;
- component-level quality-control checks.

The grayscale preview was not recorded as viewed in the decision note. The visual decisions are approved, but representative components still require production grayscale and photocopy testing before v1.0.
...
- map standards;
- timeline graphics;
- figure caption and attribution details beyond the current base rules;
...
## 41.1 Decisions Carried Forward
...
| Panel use | Selective |
| Evidence structures | Multiple functional families |

The v0.5 decision note records that the grayscale preview was not viewed. Production grayscale and photocopy testing remains required before v1.0.
