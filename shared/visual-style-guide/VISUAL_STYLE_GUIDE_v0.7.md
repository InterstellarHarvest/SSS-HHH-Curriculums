# VISUAL_STYLE_GUIDE_v0.7

> **Repository Draft**  
> **Projects:** *Space Sprout Sleuth* (SSS) and *Hunger, Harvest, & History* (HHH)  
> **Status:** v0.7 — Institutional Insignia, Section Icons, Semantic Markers, and Publication Status  
> **Supersedes:** `VISUAL_STYLE_GUIDE_v0.6.md`  
...
> **Next planned revision:** v0.8 — Covers, image treatment, game-asset reuse, artwork frames, and packet openers
...
Version 0.7 carries forward all approved v0.6 standards and locks the institutional identity and marker systems used across SSS and HHH curriculum materials.

Approved choices:

- **SAA insignia direction:** A · Solar Sprout
- **Institutional master strategy:** Dual-master system
- **Section-icon density:** Every recurring standardized section
- **Semantic-marker treatment:** Icon + technical label
- **Publication-status mark:** Filled status mark
- **Insignia color preview:** Institutional color
- **TAA source status:** Existing pixel insignia remains the canonical game source
- **Institutional separation:** Insignia, section icons, semantic markers, and publication marks remain distinct systems

This revision defines the SAA Solar Sprout brief, TAA/SAA vector and pixel responsibilities, required mark variants, section-icon assignments, semantic callouts, publication-status marks, placement rules, accessibility expectations, CSS tokens, and quality-control tests.

The grayscale page preview was not recorded as viewed. Final production marks still require grayscale, one-color, small-size, and classroom-print testing before v1.0.
...
# 72. Deferred Specifications

The following remain unresolved:

- final production drawing of the SAA Solar Sprout insignia;
- final curriculum vector adaptation of the TAA insignia;
- exact minimum sizes after optical testing;
- final matched SAA pixel insignia;
- final approved Phosphor glyph for each section after small-size testing;
- cover and packet-opener design;
- image, photograph, screenshot, and game-asset treatment;
- assessment and rubric specializations;
- teacher-answer overlays;
- accessibility variants;
- export and repository-production standards;
- completed grayscale, photocopy, and printer tests.
...
|---|---|
| SAA insignia direction | A · Solar Sprout |
| Institutional strategy | Dual-master system |
| Section-icon density | Every recurring standardized section |
| Semantic marker | Icon + technical label |
| Publication-status mark | Filled status mark |
| Insignia color | Institutional color |
| TAA pixel mark | Preserved as canonical game source |

The grayscale preview was not recorded as viewed. Final production marks still require grayscale, one-color, small-size, and print testing.
...
- Locked the Solar Sprout direction for SAA.
- Locked the dual vector-and-pixel institutional master strategy.
- Preserved the existing TAA pixel mark as the canonical game source.
- Defined curriculum vector responsibilities.
- Locked icons on every recurring standardized section.
- Defined the controlled section-icon vocabulary.
- Locked icon-plus-technical-label semantic markers.
- Locked filled publication-status marks.
- Defined role-label separation, placement, CSS tokens, and quality-control checks.

## v0.6

- Locked direct labels, restrained line hierarchy, orthogonal connectors, technical figure frames, caption metadata bands, sourced map geometry, and grayscale-independent graph encoding.

## v0.5

- Locked Technical Label Headings, callouts, response boxes, tables, teacher notes, technical rounding, and evidence-layout families.

## v0.4

- Locked Mission Title Block, continuation headers, modular grid, margins, density, and footer.
...
- Corrected SAA to Solar Agricultural Authority and defined SAA/TAA brand architecture.
