# VISUAL_STYLE_GUIDE_v0.8

> **Repository Draft**  
> **Projects:** *Space Sprout Sleuth* (SSS) and *Hunger, Harvest, & History* (HHH)  
> **Status:** v0.8 — Covers, Image Treatment, Historical Sources, Scientific Artwork, and Game-Asset Reuse  
> **Supersedes:** `VISUAL_STYLE_GUIDE_v0.7.md`  
...
> **Next planned revision:** v0.9 — Forms, CER, vocabulary, rubrics, answer keys, navigation, accessibility, and print-production QA
...
Version 0.8 carries forward all approved v0.7 standards and locks the imagery and cover system used across SSS and HHH curriculum materials.

Approved choices:

- **Ordinary cover structure:** Mission-title cover
- **Image frame treatment:** Thin technical frame
- **Caption and source treatment:** Caption metadata band
- **Historical-photo treatment:** Retain authentic tonal character
- **Game-asset reuse policy:** Selective framed reuse
- **Image justification:** Every image must serve an instructional or documentary function
- **Image status:** Curriculum-original, reproduced, adapted, scanned, mapped, photographed, and game-derived material must be identified explicitly

This revision defines:

- packet covers and case dividers;
- packet openers;
- historical photographs;
- scans and source excerpts;
- scientific and historical illustrations;
- screenshots and sprite panels;
- maps treated as image assets;
- image crops and matched comparisons;
- caption metadata;
- attribution and rights records;
- pixel-art scaling;
- selective game-asset reuse;
- imagery accessibility;
- cover and image QA.

The grayscale preview was not recorded as viewed in the v0.8 decision note. Representative pages still require production grayscale and photocopy testing before v1.0.
...
# 89. Deferred Specifications

The following remain unresolved until v0.9 and v1.0:

- CER specialization;
- vocabulary components;
- forms and controls;
- assessment and rubric systems;
- teacher-answer treatments;
- page navigation;
- accessible editions;
- final print-production standards;
- completed grayscale, photocopy, duplex, and printer testing.
...
|---|---|
| Cover structure | Mission-title cover |
| Image frame | Thin technical frame |
| Caption / source | Caption metadata band |
| Historical photo | Retain authentic tonal character |
| Game-asset reuse | Selective framed reuse |
| Image purpose | Instructional or documentary justification required |
| Source distinction | Required |

The grayscale preview was not recorded as viewed. Production grayscale and photocopy testing remains required before v1.0.
...
- Locked Mission-Title Covers.
- Defined cover hierarchy, hero-image limits, and exceptions.
- Locked thin technical framing across imagery.
- Locked caption metadata bands.
- Locked authentic tonal treatment for historical photographs.
- Defined scan and excerpt handling.
- Defined curriculum-original illustration rules.
- Defined screenshot and pixel-art requirements.
- Locked selective framed reuse of game assets.
- Defined comparison, crop, attribution, rights, and accessibility rules.
- Added imagery CSS tokens and QA checklist.

## v0.7

- Locked the SAA/TAA identity strategy, recurring section icons, semantic markers, and publication marks.

## v0.6

- Locked explanatory-visual, figure, map, graph, timeline, provenance, caption, and source-status systems.
...
- Locked page architecture, grid, margins, headers, footers, and density.
