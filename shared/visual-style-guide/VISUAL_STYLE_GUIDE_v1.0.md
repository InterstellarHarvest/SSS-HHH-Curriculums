# VISUAL_STYLE_GUIDE_v1.0

> **Repository Standard**  
> **Projects:** *Space Sprout Sleuth* (SSS) and *Hunger, Harvest, & History* (HHH)  
> **Status:** v1.0 — Approved Shared Visual Standard  
> **Supersedes:** `VISUAL_STYLE_GUIDE_v0.9.md`  
...
| Primary use | Govern all shared SSS and HHH curriculum visuals, templates, imagery, assessment components, accessible variants, and production QA |
...
| Current maturity | Approved v1.0 system with reference templates, component-selection guidance, asset inventory, release gates, and maintenance rules |
...
Version 1.0 consolidates all approved decisions from v0.1 through v0.9 into the authoritative shared visual standard for *Space Sprout Sleuth* and *Hunger, Harvest, & History* curriculum materials.

No new major visual language is introduced in v1.0.

Version 1.0 completes:

- final source-of-truth hierarchy;
- reconciliation of approved decisions;
- component-selection guidance;
- current asset inventory;
- representative SSS student template;
- representative HHH student template;
- representative teacher template;
- representative answer-key template;
- representative accessible-edition template;
- release and compliance gates;
- maintenance and change-control rules;
- deprecation guidance for older guides and decision labs.

The following systems are authoritative:

- institutional identity;
- typography;
- grayscale and institutional color;
- page geometry;
- Mission Title Block;
- continuation headers;
- footer metadata;
- Technical Label Headings;
- Phosphor section icons;
- semantic markers;
- callouts;
- response boxes;
- tables;
- explanatory visuals;
- maps, timelines, graphs, and provenance diagrams;
- images, scans, screenshots, and game assets;
- covers;
- CER;
- vocabulary;
- forms and controls;
...
Physical grayscale, printer, and photocopy tests remain release tasks for each published template or packet. They are not grounds for inventing a new visual system outside this guide.
...
- Solar Sprout as the approved SAA sister-insignia direction
- Dual vector-and-pixel institutional master strategy
- Phosphor icons on every recurring standardized section
- Icon-plus-technical-label semantic markers
- Filled publication-status marks
- Mission-title covers as the ordinary packet and opener default
- Thin technical frames for photographs, scans, screenshots, illustrations, maps, and game assets
- Caption metadata bands across sourced imagery
- Authentic tonal character retained for historical photographs
- Selective framed reuse of game assets
- Explicit distinction among curriculum-original, reproduced, adapted, scanned, and game-derived imagery
- Strict separation between institutional, instructional, semantic, and publication symbols
...
## 7.3A Institutional Document Archetypes

SSS and HHH intentionally share one publishing system. They should not be forced into unrelated layouts merely to look different.

Their distinction should be strongest in the recurring **document structures and evidence language**.

### SSS / SAA Operational Archetype

SSS materials should preferentially use:

- mission questions;
- system status or environment readings;
- plant or habitat observations;
- mechanism diagrams;
- condition → mechanism → effect relationships;
- diagnosis;
- engineering or operational recommendation;
- mission debrief.

Its visual character should feel operational, empirical, and systems-oriented.

### HHH / TAA Archival Archetype

HHH materials should preferentially use:

- accession or record identifiers;
- date, period, and region fields;
- source excerpts;
...
Its visual character should feel archival, evidentiary, and continuity-oriented.

### Shared-Family Rule

The following remain intentionally shared:
...
A document is sufficiently differentiated when its institution, terminology, recurring evidence structures, metadata, and visual emphasis are appropriate. It does not need ornamental borders or a separate publishing system.
...
## 9.4A Reference-Template Type Enforcement

Reference templates must implement the print scale at its true point-equivalent size.

For a 96 CSS-pixel-per-inch US Letter preview, approximate equivalents are:

| Print size | CSS equivalent |
|---:|---:|
| 22 pt | 29.3 px |
| 15 pt | 20 px |
| 12 pt | 16 px |
...
Do not build a visually convenient preview with undersized CSS text and then treat the screenshot as evidence that the approved print scale is too small.

Teacher Quick Start pages use the ordinary body and table sizes unless a documented compact-density exception applies.
...
## 21.5 Page-Fill and Flexible-Space Rule

Use the printable page area deliberately.

### Student Work Pages

When a page contains flexible writing, drawing, annotation, or graphing areas, expand those areas before leaving avoidable blank space beneath them.

Priority order for surplus vertical space:

1. written response areas;
2. drawing or annotation areas;
3. student-created graphs or models;
4. evidence-table writing rows;
5. explanatory figures that benefit from enlargement.

For a stack of related response boxes, distribute surplus space evenly across the flexible boxes while preserving their minimum instructional hierarchy.

For CER:

- Claim retains the smallest minimum;
- Evidence retains a larger minimum;
- Reasoning retains the largest minimum;
- any additional page surplus is added equally to all three boxes.

Do not leave a large unused region below active student response components when those components can productively expand.
...
1. handwriting and typed-response areas;
2. drawing, labeling, and annotation areas;
3. enlarged graphing or modeling areas;
...
- the page boundary and footer remain intact;
- the larger area improves physical usability;
- the box does not create an unnecessary extra page elsewhere.

Accessible response areas should not be held to the ordinary page's minimum dimensions merely for visual consistency.
...
Do not inflate type, padding, or decorative panels merely to fill a page.

Use this order:

1. combine content from a following page when it fits cleanly;
2. include omitted but genuinely required quick-reference content;
3. provide a useful teacher-notes or annotation area;
4. reduce the declared page count;
5. accept intentional whitespace.

A half-empty `Page 1 of 2` is a layout failure when the required Page 2 content could have fit legibly on Page 1.

A short one-page reference may retain intentional whitespace when no useful flexible component or additional required content exists.

### Page-Fill Prohibition

Do not fill a page by:

- enlarging fonts beyond the approved hierarchy;
- adding decorative imagery;
- repeating instructions;
- creating unnecessary panels;
...
# 59. Identity-System Architecture

## 59.1 Four Separate Systems

The curriculum uses four distinct visual systems:

- **Institutional insignia** identify SAA or TAA.
- **Section icons** identify recurring instructional functions.
- **Semantic markers** identify documented, inferred, fictional, caution, optional, or confirmed content.
- **Publication marks** identify Draft, Review, Approved, Deprecated, Archived, or Superseded status.

These systems must never substitute for one another.

## 59.2 No Symbol Inflation

A page must not display repeated institutional insignia, icons on ordinary paragraphs, semantic markers without callout content, or multiple workflow statuses competing for attention.

---

# 60. SAA Solar Sprout Insignia

## 60.1 Approved Direction

The approved SAA concept is **A · Solar Sprout**.

The mark combines:

- compact circular institutional field;
- central living sprout;
- solar disc;
- orbital geometry;
- SSS institutional colors.

## 60.2 Meaning

The mark communicates living agriculture, solar-system operations, controlled scientific cultivation, growth beyond Earth, and international scientific authority.

## 60.3 Relationship to TAA

- **TAA:** agriculture preserved through time.
- **SAA:** living agriculture sustained through the solar system.

The two marks should share comparable circular mass, compact density, a central agricultural symbol, surrounding scientific geometry, small-size legibility, and one-color viability.

## 60.4 Required Core Geometry

The refined SAA mark should preserve one central stem, two simplified leaves, one solar disc, one orbital path, and one compact outer boundary.

## 60.5 Prohibited Treatments

Do not add dominant rockets, military wings, shield-heavy law-enforcement forms, gradients, glows, detailed starscapes, greenhouse clip art, or imitation NASA geometry.

## 60.6 Refinement Required

The selected direction is a locked design brief, not final production artwork. Final development still requires optical balancing, path simplification, small-size simplification, one-color testing, reversed testing, pixel adaptation, and print testing.

---

# 61. TAA Insignia Treatment

## 61.1 Canonical Source

The existing 96 × 96 pixel-art TAA insignia remains the canonical game source mark.

## 61.2 Curriculum Vector

The curriculum may use a vector adaptation preserving the central grain motif, temporal or orbital arcs, compact circular silhouette, amber and cyan identity, vertical organization, and recognition of the shipped sprite.

## 61.3 Pixel Use

Use the source pixel mark in game-derived screenshots, pixel-art contexts, game-reference pages, and controlled promotional material.
...
# 62. Dual-Master Strategy

## 62.1 Approved Strategy

Each institution receives both a vector curriculum master and a pixel game master or matched pixel adaptation.
...
The pixel master controls game continuity, pixel-art contexts, screenshots, retro interface reproductions, and controlled game-derived use.

## 62.4 Required Variants

Each institution should eventually provide:
...
## 62.5 Cross-Master Consistency

Vector and pixel forms must preserve silhouette, central symbol, major geometry, institutional identity, and relative visual weight.

---

# 63. Insignia Color, Size, and Placement

## 63.1 Color Variants

SAA uses Orbital Cyan and Botanical Green. TAA uses Archive Amber and Record Cyan. One-color dark uses Mission Ink. One-color light uses Paper White.

Do not recolor institutional marks to match lesson topic, semantic status, campaign, or decoration.

## 63.2 Required Size Tests

Test at 96, 64, 48, 32, 24, and 20 px plus equivalent print sizes.

Until final testing:

- do not use the detailed primary mark below 32 px;
- use a simplified small-size mark below 32 px;
- do not use the mark below 20 px.

## 63.3 Clear Space

Minimum clear space should equal at least one-quarter of the mark diameter.

## 63.4 Placement

- First page: reserved Mission Title Block position.
- Continuation page: simplified small-size mark.
- Cover: larger mark permitted.
- Footer: do not repeat the insignia on every page.
- Watermark: prohibited behind body text or response areas.

---

# 64. Section-Icon System

## 64.1 Approved Density

Use a Phosphor icon on **every recurring standardized section**.

This means shared sections with a stable name and function. It does not mean every heading, paragraph, or one-off subsection receives an icon.

## 64.2 Initial Controlled Vocabulary

| Section | Phosphor concept |
|---|---|
| Mission Brief / Case Setup | Satellite |
| Science Focus | Atom or Leaf |
| History Focus | Clock Counterclockwise, Scroll, or Archive |
| Vocabulary | Book Open Text |
| Prediction / Initial Thinking | Lightbulb |
| Evidence | Magnifying Glass |
| Observation | Eye |
| Mechanism | Gear |
| Source / Provenance | File Search or Git Branch |
| Timeline | Timeline |
| Map | Map Trifold |
| CER | Note Pencil |
| Recommendation | Wrench |
| Reflection / Debrief | Check Square |
| Exit Ticket | Check Circle or Sign Out |
| Optional Extension | Star |
| Technical Fallback | Lifebuoy or Wrench |
| Accessibility | Universal Access |
| Teacher Note | Chalkboard Teacher |

Exact glyphs may change after small-size testing.

## 64.3 Standard Arrangement

```text
[ICON + TECHNICAL LABEL] Section heading
```

## 64.4 Consistency

The same function uses the same icon across SSS, HHH, student, teacher, digital, and print versions.

## 64.5 One-Off Sections

A one-off subsection may use technical label only or a plain heading. Do not invent a new icon for every lesson phrase.

## 64.6 Labels Remain Required

The icon never replaces visible text.

---

# 65. Semantic Marker System

## 65.1 Approved Treatment

Use **Icon + Technical Label** inside the approved left-rule callout.

## 65.2 Marker Anatomy

A semantic callout contains a colored left rule, pale field, small Phosphor icon, technical label, and concise body.

## 65.3 Controlled Vocabulary

| Meaning | Label |
|---|---|
| Science concept | Science Focus |
| Historical reasoning | History Focus |
| Established principle | Established Science |
| Direct source support | Documented |
| Plausible extension | Plausible Extrapolation |
| Interpretation or uncertainty | Inferred / Debated |
| Game-world material | Fictional Context |
| Important limitation | Caution |
| Supported result | Confirmed |
| Nonrequired task | Optional |
| Teacher-only note | Teacher Note |
| Alternate workflow | Technical Fallback |
...
One marker identifies the whole callout. Split mixed-status content rather than stacking several marker icons in one heading.

---

# 66. Filled Publication-Status Marks

## 66.1 Approved Treatment

Use a compact filled rectangular mark with 3 px technical radius, solid status color, white JetBrains Mono text, optional small Phosphor icon, no rotation, and no distressed texture.

## 66.2 Workflow States
...
## 66.3 Preferred Colors

| Status | Color |
|---|---|
| Draft | Caution Amber |
| Review | Technical Slate |
| Approved | Success Green |
| Deprecated | Critical Red |
| Archived | Technical Slate |
| Superseded | Critical Red or Technical Slate |

## 66.4 Placement

Use publication marks on covers, title pages, repository preview sheets, teacher packet openers, controlled review copies, or quiet footer metadata.

Do not place a large APPROVED mark on every student worksheet page.

## 66.5 One Workflow State

A document normally displays one workflow state. Do not show Draft and Approved together.

## 66.6 No Fake Rubber Stamp

Do not rotate, distress, blur, or simulate uneven ink.

---

# 67. Document-Role Labels

Approved role labels include Student Edition, Teacher Edition, Answer Key, Accessible Version, Fillable Version, and Large-Print Version.

A role label is not publication status and is not an institutional mark.

Role labels may appear in the Mission Title Block, covers, compact publication metadata, and downloadable-file descriptions.

---

# 68. Placement and Repetition

## 68.1 First Page

A first page may contain one institutional insignia, recurring section icons, required semantic markers, and one role or publication mark where appropriate.

## 68.2 Continuation Page

Use the simplified institutional mark, recurring section icons, required semantic markers, and quiet publication metadata.

## 68.3 Covers

Covers may use a larger insignia, role label, publication mark, campaign title, and packet title. These remain visually distinct.

## 68.4 Teacher and Answer Materials

Teacher documents and answer keys use the same institutional and section-icon vocabulary as student documents, with additional teacher-only markers where needed.

---

# 69. Accessibility

Digital insignia require accessible text identification unless adjacent text makes them redundant.

Section icons and semantic markers require visible text labels.

Publication marks require visible wording.

Every mark must remain identifiable in one-color output.
...
```css
:root {
  --insignia-clear-space: 25%;
  --insignia-header-size: 0.54in;
  --insignia-continuation-size: 0.26in;
  --section-icon-size: 14pt;
  --semantic-icon-size: 14pt;
  --status-draft: #8a5a00;
  --status-review: #4b5967;
  --status-approved: #236b3b;
  --status-deprecated: #8f2f2f;
}
```
...
# 71. Quality-Control Checklist

## 71.1 SAA

- [ ] Follows the Solar Sprout direction.
- [ ] Sun, sprout, and orbit remain legible.
- [ ] Does not resemble NASA, military, or energy-company identity.
- [ ] Remains distinct from TAA.
- [ ] Works in one color.
- [ ] Has simplified and pixel forms.

## 71.2 TAA

- [ ] Existing pixel insignia is preserved.
- [ ] Vector adaptation remains recognizably the same institution.
- [ ] Grain and temporal geometry remain legible.
- [ ] Vector and pixel forms have comparable weight.

## 71.3 Section Icons

- [ ] Every recurring standardized section uses its approved icon.
- [ ] One-off subsections do not receive arbitrary icons.
- [ ] Icons retain text labels.
- [ ] Same function uses same icon across SSS and HHH.
- [ ] Institutional insignia are not used as section icons.

## 71.4 Semantic Markers

- [ ] Use icon plus technical label.
- [ ] Sit inside the approved callout system.
- [ ] Pair color with text.
- [ ] Use one primary marker per callout.

## 71.5 Publication Marks

- [ ] Use filled marks.
- [ ] Remain unrotated and undistressed.
- [ ] Show one workflow state.
- [ ] Keep role labels separate from status.
- [ ] Do not repeat large approval marks on every student page.

## 71.6 Print and Accessibility

- [ ] Grayscale and one-color forms remain recognizable.
- [ ] Filled marks retain contrast.
- [ ] Small-size tests pass.
- [ ] Clear space is preserved.

---

# 72. Image-System Principles

## 72.1 Instructional Justification
...
- document a source;
- support comparison;
- show spatial or chronological relationships;
- connect gameplay to curriculum reasoning;
- provide a necessary visual reference.

Images must not be added merely to fill space, decorate headings, or make a page appear more game-like.

## 72.2 Documentary Categories

Every image is identified as one or more of:

- curriculum-original illustration;
- adapted figure;
...
SSS and HHH use the same framing, captioning, attribution, cropping, grayscale, and accessibility rules. Institutional color and subject matter may differ.

---

# 73. Mission-Title Cover

## 73.1 Approved Default

The ordinary packet and opener use a **Mission-Title Cover** containing:

1. institution and document role;
2. packet, campaign, or case title;
3. restrained subtitle;
4. one controlled hero visual;
5. role, edition, or status metadata.

## 73.2 Hierarchy

The title remains dominant. The hero visual supports the title rather than replacing it.

## 73.3 Hero Visual

The cover normally uses one hero visual occupying approximately 35–55% of the usable cover area.
...
## 74.1 Hero-Image Cover

A larger hero-image cover may be used for campaign openers, portfolio artifacts, showcase documents, and graduate-program submissions.

## 74.2 Banded Dossier Cover

A banded dossier cover may be used for HHH source collections, evidence dossiers, teacher appendices, and archive packets.

## 74.3 Divider Pages

Divider pages may use a larger insignia and one image with minimal supporting text.

---

# 75. Image Framing

## 75.1 Approved Default

Use a **Thin Technical Frame** around:
...
- controlled padding;
- no shadow;
- no ornamental double border.

## 75.3 Open-Image Exception

Transparent standalone illustrations may remain open when the caption band supplies sufficient structure.

## 75.4 Pale-Field Exception

A pale field may be used when a white or transparent image would disappear into the page.

---

# 76. Caption Metadata Bands

## 76.1 Approved Default

Use the v0.6 **Caption Metadata Band** for all sourced imagery.

The band contains as applicable:

1. figure number;
2. descriptive caption;
3. source status;
4. attribution;
5. crop or adaptation note;
6. scale or reconstruction notice.

## 76.2 Example — Game Asset

```text
Figure 4. Lettuce tray condition after directional cues were removed.

SOURCE · SPACE SPROUT SLEUTH GAME ASSET
SCREENSHOT · CROPPED FOR INSTRUCTIONAL USE
```

## 76.3 Example — Historical Photograph

```text
Figure 2. Agricultural workers examining an experimental wheat plot.

REPRODUCED FROM · ARCHIVE / CREATOR / YEAR
TONAL CHARACTER PRESERVED
```

## 76.4 Placement

The caption band remains directly beneath the image, in the same column, on the same page.

---

# 77. Historical Photographs

## 77.1 Approved Treatment

Retain the **authentic tonal character** of historical photographs.

## 77.2 Permitted Adjustments
...
- straighten;
- rotate;
- modest contrast correction;
- severe color-cast correction;
- grayscale conversion where print requires it;
- border cleanup;
- framing and captioning.

## 77.3 Preservation Rule

Preserve relevant grain, sepia, monochrome tone, edge damage, source marks, and archival texture.

## 77.4 Disclosure

Substantial restoration, colorization, reconstruction, or compositing must be disclosed.

## 77.5 Prohibited Filters

Do not add faux film grain, artificial sepia, vignette, paper damage, selective color, or pixelation.

---

# 78. Document Scans and Excerpts

## 78.1 Source Identity

Scans remain visibly distinct from ordinary curriculum text.

## 78.2 Relevant Features

Retain margins, accession marks, handwritten amendments, folds, corrections, and damage when they matter to interpretation.
...
Provide transcription, translation, enlarged detail, or accessible text when needed.

## 78.5 Modification Disclosure

Disclose crop, rotation, cleanup, highlighting, translation, redaction, or contrast adjustment.

---

# 79. Curriculum-Original Illustrations

## 79.1 Appropriate Uses

Create curriculum-original illustrations when:

- no suitable source image exists;
- a mechanism needs simplification;
- matched conditions are required;
- fictional content must be shown;
- source imagery would mislead;
- student annotation needs a clean base.

## 79.2 Style

Follow the v0.6 diagram system:

- direct labels;
- two neutral line weights;
- one instructional accent;
- orthogonal connectors;
- thin technical frame;
- caption metadata band.

## 79.3 Fictional Status

Use `FICTIONAL VISUALIZATION` when an image could be mistaken for real evidence.

---

# 80. Screenshots

## 80.1 Appropriate Uses

Screenshots may orient students, identify a control, compare game and real systems, document a case state, support technical fallback, or preserve gameplay evidence.

## 80.2 Crop

Crop to the relevant interface region while retaining enough context to understand the image.

## 80.3 Excluded Content

Remove unrelated browser chrome, notifications, personal information, debug overlays, editor windows, and internal paths unless required.

## 80.4 Annotation

Use numbered callouts, short labels, restrained outlines, and arrows.

## 80.5 Resolution

Screenshots must remain legible at final print size.
...
Use nearest-neighbor scaling. Never smooth pixel art.

## 81.2 Integer Scale

Prefer 2×, 3×, 4×, or 5× enlargement.

## 81.3 Crop

Crop on the pixel grid without cutting essential outlines.

## 81.4 Source Status

Label direct sprite reuse as a game asset.

---

# 82. Selective Game-Asset Reuse

## 82.1 Approved Policy

Use **Selective Framed Reuse**.

## 82.2 Appropriate Uses

Game assets may support:
...
## 82.3 Inappropriate Uses

Do not use game assets merely to decorate titles, fill space, repeat characters, or replace a clearer curriculum-original figure.

## 82.4 Required Treatment
...
- caption metadata band;
- source status;
- crop note where needed.

## 82.5 Labels

```text
SOURCE · SPACE SPROUT SLEUTH GAME SCREENSHOT
```
...
## 82.6 Evidence Boundary

Game art may illustrate fictional setting or systems. It is not direct evidence of real science or history.

---

# 83. Comparative Image Structures

## 83.1 Matched Pair

Use matched frames for:
...
Use equal frame size, equivalent crop, parallel captions, and equivalent label hierarchy.

## 83.3 Unequal Reliability

Do not imply equal reliability merely by giving two sources identical visual weight. State differences explicitly.

## 83.4 Sequence

Number image sequences and preserve one reading direction.

---

# 84. Cropping and Aspect Ratio

## 84.1 Crop Purposefully

Crop to focus attention, remove irrelevant margins, support comparison, fit the grid, or preserve legibility.

## 84.2 No Distortion

Never stretch or compress an image to fit.

## 84.3 Repeated Sets

Repeated sets should share one aspect ratio unless a source difference is instructionally important.

---

# 85. Attribution and Rights

## 85.1 Required Record
...
## 85.2 Student and Teacher Detail

Student pages may use concise attribution. Teacher and source documentation retain full attribution.

## 85.3 Generated Imagery

Generated imagery must not be presented as a historical photograph, archive scan, or measured scientific image.

## 85.4 Unverified Rights

Do not publish imagery with uncertain rights status without review.

---

# 86. Image Accessibility

## 86.1 Alt Text

Alt text reflects the image's instructional purpose.

## 86.2 Complex Sources

Provide transcript, translation, enlarged detail, accessible table, or extended description where needed.

## 86.3 Screenshots

Alt text identifies the interface region, relevant control, and required action.

## 86.4 Color Independence

Essential meaning must survive grayscale.

---

# 87. Cover and Image CSS Tokens

```css
:root {
  --image-radius: 3px;
  --image-border: 0.75pt solid var(--rule);
  --image-padding: 0.10in;
  --caption-band-fill: var(--panel-light);
  --caption-band-border: 0.75pt solid var(--rule);
}
```
...
.image-caption-band {
  margin-top: 0.06in;
  border: var(--caption-band-border);
  border-radius: var(--image-radius);
  background: var(--caption-band-fill);
  padding: 0.07in 0.08in;
}
```
...
# 88. Cover and Image Quality-Control Checklist

## 88.1 Cover

- [ ] The ordinary cover follows the Mission-Title Cover.
- [ ] The title remains dominant.
- [ ] One relevant hero visual is used.
- [ ] Institutional identity remains clear.
- [ ] Metadata is subordinate.
- [ ] No decorative collage or game-HUD treatment appears.

## 88.2 Frame and Caption

- [ ] The image uses a thin technical frame unless an exception is justified.
- [ ] The caption metadata band appears directly beneath it.
- [ ] Source status is explicit.
- [ ] Crop or adaptation is disclosed when needed.
- [ ] Image and caption remain on the same page.

## 88.3 Historical Sources

- [ ] Authentic tonal character is retained.
- [ ] Cropping does not alter meaning.
- [ ] Substantial restoration is disclosed.
- [ ] No decorative filter is applied.
- [ ] Source and date are recorded.

## 88.4 Screenshots and Game Assets

- [ ] Reuse is selective.
- [ ] The crop is instructionally focused.
- [ ] Game status is identified.
- [ ] Pixel art uses nearest-neighbor scaling.
- [ ] A clearer curriculum-original figure was considered.
- [ ] Game art is not presented as real evidence.

## 88.5 Accessibility

- [ ] Alt text matches the image's purpose.
- [ ] Complex imagery has extended support where needed.
- [ ] Meaning survives grayscale.
- [ ] Labels remain legible.

---

# 89. Specialized-System Principles

## 89.1 Same Curriculum, Different Support

Specialized components must preserve the same objective, content order, section names, evidence expectations, and institutional identity.

A scaffold, answer key, or accessible edition may change how a learner accesses or records the work. It must not silently change what the lesson teaches.

## 89.2 Shared Component Family

CER, vocabulary, forms, rubrics, answers, and accessible variants continue to use:
...
The Claim box asks the student to answer the investigation question, state a diagnosis, or make a supportable interpretation.

It is normally the shortest box.

## 90.3 Evidence

The Evidence box asks the student to cite observations, sources, records, or data.

It is normally taller than the Claim box.

## 90.4 Reasoning

The Reasoning box asks the student to explain the mechanism or connect evidence to the interpretation.

It is normally the tallest box.

## 90.5 Relative Height

Typical relationship:

```text
Claim       1 unit
Evidence    1.5–2 units
Reasoning   2–2.5 units
```
...
Do not use decorative bracket shapes, notebook lines, color-only distinctions, or three unrelated visual styles.

---

# 91. Vocabulary System

## 91.1 Approved Default

Use a **Term-Definition Table**.

## 91.2 Ordinary Structure
...
## 91.3 Student-Completed Version

A student version may provide the term with blank definition, example, drawing, or application fields.

## 91.4 Illustrated Card Exception

Use vocabulary cards only when a small number of terms require substantial visual explanation.

## 91.5 Compact Strip Exception

Use compact strips for previously learned quick-reference terms, not for initial instruction.

---

# 92. Forms and Selection Controls

## 92.1 Checkboxes

Use square checkboxes for select-all, completion, observation, criteria confirmation, and procedural steps.

## 92.2 Single Choice

Use circular controls for choose-one, yes/no, one diagnosis, or one confidence category.
...
- 0.14–0.18 inches;
- approximately 14–18 CSS pixels digitally.

## 92.4 Labels

Place a visible text label immediately beside every control.

## 92.5 Digital Behavior

Digital controls require keyboard access, visible focus, programmatic labels, and printable fallback.

## 92.6 Grayscale

Selected state must remain visible without color.

---

# 93. Scales and Rankings

## 93.1 Endpoint Labels
...
- 3 points for simple categories;
- 4 points when avoiding a default middle choice;
- 5 points when a meaningful neutral midpoint exists.

## 93.3 Confidence

Confidence is not correctness.

## 93.4 Evidence Strength

Use explicit terms such as Weak, Limited, Moderate, and Strong.

## 93.5 Ranking

State what is ranked, the criterion, whether ties are allowed, and how uncertainty is handled.

---

# 94. Rubric System

## 94.1 Approved Default

Use an **Analytic Criteria Grid**.

Criteria are rows.

Proficiency levels are columns.

## 94.2 Preferred Levels
...
or the first three when a three-level rubric is sufficient.
...
Descriptors must be observable, parallel, concise, and meaningfully distinct.

## 94.5 Checklist Exception

Use checklist rubrics for completion and short procedural tasks.

## 94.6 Single-Point Exception

Use single-point rubrics when narrative feedback is more useful than multiple levels.

---

# 95. Teacher Answer-Key System

## 95.1 Approved Default

Use **Dedicated Answer-Key Blocks**.

## 95.2 Order

The answer key mirrors the student document order.

## 95.3 Block Anatomy

A complete answer block may include:

1. student prompt;
2. model response;
3. accepted alternatives;
4. required evidence;
5. common incomplete response;
6. misconception;
7. scoring note;
8. source or science boundary.

## 95.4 Model Response

A model response demonstrates acceptable completeness without implying that only one exact wording is valid.

## 95.5 Alternatives

List alternate valid wording, evidence combinations, mechanisms, interpretations, or design solutions.

## 95.6 Styling

Use a dedicated answer-key label, neutral or Success Green side rule, pale field, and ordinary readable body text.

Do not imitate handwritten red-pen notes.
...
Teacher answers must not appear in student output or leave unexplained empty areas when hidden.

---

# 96. Page Navigation

## 96.1 Running Identity

Continuation pages use the compact header approved in v0.4.
...
## 96.3 Running Metadata

Running navigation may include campaign, case, title, role, and continuation label.

## 96.4 Internal References
...
Avoid vague references such as `see above`.

## 96.5 Contents

Use a contents page for long teacher packets, campaign resources, and formal portfolio submissions.

## 96.6 Side Tabs

Digital or teacher side tabs may be used when they remain inside printable safety.

---

# 97. Parallel Accessible Editions

## 97.1 Approved Strategy

Create a **Parallel Accessible Edition**.

It preserves content order, identifiers, objectives, source identity, and answer-key relationship.

## 97.2 Permitted Adaptations

The accessible edition may use:
...
Large-print versions normally begin at 16–18 pt body text with proportionally larger headings and spacing.

## 97.4 Alternate Responses

Permitted modes include typed, speech-to-text, oral, selected response, labeled diagram, reduced-length writing, scribed, and audio response.

## 97.5 Reading Order

Digital editions require logical reading order across header, prompt, guidance, response, figure, caption, and source line.

## 97.6 Stable Identifiers

Accessible pages use the same case, section, figure, question, and source identifiers as the standard edition.

## 97.7 Adaptive Master

One HTML master may generate the parallel accessible output, but the published edition receives its own QA.

---

# 98. Print-Production Standards
...
Ordinary structural rules should not fall below approximately 0.5 pt.

Critical borders and icons should remain heavier.

## 98.3 Pale Fills

Test Cool Wash, institutional pale fields, teacher-note fills, caption bands, and uncertainty patterns.

Borders and labels must preserve meaning if a pale fill disappears.

## 98.4 Photocopy Survival

Second-generation copies must preserve labels, response borders, table grids, semantic markers, figure lines, map boundaries, and status labels.

## 98.5 Low-Ink Edition

A low-ink version may remove nonessential pale fills while retaining borders, labels, identity, and required distinctions.

## 98.6 Duplex

Verify page order, orientation, blank backs, continuation identity, margins, and show-through.

## 98.7 Binding and Punch

Verify binder, staple, left-edge binding, annotation, and three-hole-punch safety.

## 98.8 QR Codes

Printed QR codes require physical scan testing, sufficient size, quiet zone, contrast, and readable destination text.

## 98.9 Printer Independence

No page depends on borderless printing.

---

# 99. Print-Test Matrix
...
| Photocopy | Required | Required | Required |
| Second-generation copy | Required | Sample | Required |
| Duplex | Where applicable | Required | Where applicable |
| Punch / binding | Required | Required | Required |
| Fillable controls | Where applicable | Where applicable | Required |

---

# 100. Specialized CSS Tokens

```css
:root {
  --form-control-size: 0.16in;

  --cer-claim-height: 0.70in;
  --cer-evidence-height: 1.10in;
  --cer-reasoning-height: 1.45in;

  --answer-rule: #236b3b;
  --answer-fill: #edf5ef;

  --large-print-body: 18pt;
  --large-print-leading: 1.5;

  --print-min-rule: 0.5pt;
}
```
...
.answer-key-block {
  border-left: 3px solid var(--answer-rule);
  border-radius: var(--component-radius);
...
.accessible-edition {
  --body-size: var(--large-print-body);
  --body-leading: var(--large-print-leading);
  --grid-gutter: 0.16in;
}
```
...
# 101. Specialized-System Quality-Control Checklist
...
- [ ] The ordinary format is a term-definition table.
- [ ] Definitions are accurate and consistent.
- [ ] Cards and strips are justified exceptions.
- [ ] Student-completed versions provide enough writing space.

## 101.3 Forms and Scales

- [ ] Checkbox and single-choice meanings are correct.
- [ ] Every control has a visible label.
- [ ] Selected state survives grayscale.
- [ ] Digital controls are keyboard accessible.
- [ ] Scale endpoints are labeled.
- [ ] Confidence is not confused with correctness.

## 101.4 Rubrics

- [ ] The ordinary rubric is analytic.
- [ ] Descriptors are observable.
- [ ] Levels are distinct.
- [ ] Student and teacher wording match.
- [ ] Color is not required.

## 101.5 Answers

- [ ] Dedicated answer-key blocks are used.
- [ ] Order mirrors student materials.
- [ ] Valid alternatives are recognized.
- [ ] Common incomplete responses are identified.
- [ ] Teacher content is absent from student output.

## 101.6 Navigation

- [ ] Continuation pages use the locked header.
- [ ] Page X of Y is accurate.
- [ ] Internal references use stable identifiers.
- [ ] Long packets use contents where helpful.

## 101.7 Accessibility

- [ ] A parallel accessible edition exists where required.
- [ ] Content order and identifiers are preserved.
- [ ] Type, spacing, and controls are enlarged appropriately.
- [ ] Alternate response modes are documented.
- [ ] Reading order is logical.

## 101.8 Print

- [ ] Color and grayscale are tested.
- [ ] Laser and low-ink output are tested.
- [ ] First- and second-generation copies are tested.
- [ ] Duplex order is correct.
- [ ] Binding and punch safety are checked.
- [ ] Pale fills and minimum rules survive.
- [ ] QR codes are physically tested where used.

---

# 102. v1.0 Release Status

## 102.1 Authority

`VISUAL_STYLE_GUIDE_v1.0.md` is the authoritative shared visual standard.

When conflicts occur:

1. v1.0 controls;
2. an approved later amendment controls only within its stated scope;
3. the Curriculum Bible controls curriculum and publishing requirements;
4. game-source assets control the appearance of directly reused game material;
5. older visual guides and decision labs remain historical records.

## 102.2 Supporting References

The v1.0 reference package includes:

- `VISUAL_STYLE_GUIDE_v1.0_QUICK_REFERENCE.md`;
- `VISUAL_STYLE_GUIDE_v1.0_ASSET_INVENTORY.md`;
- `VISUAL_STYLE_GUIDE_v1.0_COMPLIANCE_CHECKLIST.md`;
- `VISUAL_STYLE_GUIDE_v1.0_TEMPLATE_GALLERY.html`.

These files summarize or demonstrate the main guide. They do not override it.

## 102.3 Release Meaning

Approval of v1.0 means:

- the visual system is defined;
- template authors have a stable standard;
- future curriculum packets should not invent new component families;
- deviations require documentation;
- production testing occurs against known rules.

It does not mean every future case has already been laid out or every historical image has already been sourced.

---

# 103. Component-Selection Decision Tree

Use the least visually complex component that clearly performs the instructional function.

## 103.1 Ordinary Content

Use an open section with:

```text
[ICON + TECHNICAL LABEL] Section Heading
```

Do not add a panel unless grouping or status requires it.

## 103.2 Priority Information

Use a left-rule pale-field callout for:

- science or history focus;
- established or documented status;
- uncertainty;
- fictional context;
- caution;
- optional extension;
...
## 103.3 Student Writing

Use:

- ordinary prompt + blank box for standard written response;
- three stacked boxes for CER;
- drawing frame for diagrams;
- ruled technical table for structured evidence;
- checkbox or circular control for selection.

## 103.4 Evidence Organization

Choose by reasoning task:

| Task | Component |
|---|---|
| Source, observation, relevance | Evidence matrix |
| Two conditions or sources | Matched comparison |
| Ordered change | Timeline or sequence |
| Input, mechanism, effect | Cause-and-effect or mechanism diagram |
| Interacting parts | Systems diagram |
| Record relationships | Provenance diagram |
| Spatial context | Sourced map |
| Numerical comparison | Graph |
| Criteria and tradeoffs | Design-constraint table |
| Confidence or evidence strength | Labeled scale |

## 103.5 Teacher Support

Use:

- neutral side-stripe note for concise facilitation guidance;
- dedicated answer-key block for model answers;
- analytic rubric for formal scoring;
- checklist for completion;
- formal lesson-plan sections for extended teacher content.

## 103.6 Image Choice

Use, in priority order:

1. real source when direct evidence matters;
2. curriculum-original explanatory figure when simplification teaches better;
3. selective game asset when gameplay connection itself matters;
4. no image when text or structure is clearer.

## 103.7 Cover Choice

Use:

- Mission-Title Cover by default;
- hero-image cover for major openers or showcase work;
- banded dossier cover for source collections and archive packets.

---

# 104. Reference Templates

## 104.1 Required Reference Set

The v1.0 template gallery demonstrates:

- SSS student mission;
- HHH student evidence record;
- teacher quick start;
- dedicated answer key;
- parallel accessible edition.

## 104.2 Reference, Not Finished Lesson
...
Sample content is illustrative and must not be copied into a case unless it is factually and instructionally appropriate.

## 104.3 Template Inheritance
...
# 105. Asset Inventory Summary

## 105.1 Confirmed Shared Insignia Assets

The following repository assets are the current v1.0 institutional marks:

```text
shared/assets/insignia/saa.svg
shared/assets/insignia/taa.svg
```

## 105.2 Insignia Use

Use repository SVGs for:
...
Direct game pixel insignia may remain canonical within game-derived contexts.

## 105.3 Required but Separately Managed Assets

The guide also requires or permits:

- one-color insignia output;
- reversed insignia output;
- grayscale output;
- small-size variants;
- game-source pixel marks;
- Phosphor Regular icons;
- Inter;
- JetBrains Mono.

Do not claim a separate file exists unless it is present in the repository inventory.

## 105.4 Game Assets

Game sprites, screenshots, and interface art remain in their game repositories or source packages unless intentionally copied into a curriculum package with attribution.

## 105.5 Case-Specific Sources

Each case must maintain its own record of:
...
# 106. Compliance and Release Gate

A document is visually releasable only when:

1. required components follow v1.0;
2. all images and figures have source status;
3. institutional marks use repository assets;
4. student and teacher outputs are correctly separated;
5. accessible output is generated where required;
6. grayscale output is reviewed;
7. print and overflow checks pass;
8. metadata is complete;
9. no unresolved placeholder remains;
10. deviations are documented.

The detailed gate is maintained in:

```text
reference/v1.0/VISUAL_STYLE_GUIDE_v1.0_COMPLIANCE_CHECKLIST.md
```

## 106.1 Release Blockers

The following block publication:

- missing source attribution;
- teacher answers visible in student output;
- overflow;
- illegible print size;
- unsupported map geometry;
- color-only meaning;
- blurred pixel art;
- placeholder insignia or diagram;
- incorrect page numbering;
- inaccessible required figure;
...
Typographical corrections, broken references, and clarified wording may use v1.0.x.

## 107.2 System Changes

Changes to any locked system require:
...
## 107.3 New Components

A new component is justified only when no approved component performs the required function.

## 107.4 Case-Specific Exceptions

A case-specific exception must record:

- reason;
- scope;
- accessibility impact;
- print impact;
- whether it should become a future shared standard.

## 107.5 No Silent Drift

Template authors must not silently alter:
...
- header architecture;
- response treatment;
- figure status conventions;
- publication marks.

---

# 108. Deprecation and Historical Records

## 108.1 Older Guides

Versions v0.1–v0.9 are superseded by v1.0.
...
They should not be used as the current production standard.

## 108.2 Decision Labs

Decision labs remain historical evidence of reviewed alternatives.

They are not reusable production templates.

## 108.3 Provisional Artwork

Any lab artwork labeled provisional, placeholder, mockup, or candidate remains unapproved unless it was later promoted into the repository asset inventory.

## 108.4 Existing Published Documents

Older published documents do not need silent retroactive alteration.

When revised or republished, they should migrate to v1.0.

---

# 109. Final v1.0 Decision Record

| System | Approved v1.0 result |
|---|---|
| General direction | Professional curriculum + moderate in-universe identity |
| Page model | US Letter portrait, 0.50-inch margins |
| Page use | Flexible student work areas expand into usable surplus space |
...
| Grayscale | Cool Mission Gray |
| SSS color | Orbital Cyan + Botanical Green |
| HHH color | Archive Amber + Record Cyan |
| Icons | Phosphor Regular, recurring standardized sections |
| Section heading | Icon + Technical Label Heading |
| Callout | Left rule + pale field |
| Response | Prompt above blank unruled box |
| CER | Three stacked boxes |
| Table | Ruled technical |
| Teacher note | Neutral side stripe |
| Figure labels | Direct |
| Diagram connectors | Orthogonal |
| Figure frame | Thin technical |
| Caption | Metadata band |
| Map geometry | Sourced |
| Cover | Mission-title |
| Historical photos | Authentic tonal character retained |
| Game assets | Selective framed reuse |
| Vocabulary | Term-definition table |
| Rubric | Analytic criteria grid |
| Teacher answers | Dedicated answer-key blocks |
| Accessibility | Parallel accessible edition |
| Accessible page use | Surplus space expands handwriting and alternate-response areas |
| Publication status | Filled status mark |
| Print QA | Grayscale, printer, copy, duplex, binding, low-ink |
...
- Added component-selection guidance.
- Added reference-template requirements.
- Confirmed shared insignia asset paths.
- Added release blockers and compliance gate.
- Added maintenance and change-control rules.
- Added deprecation guidance.
- Added final decision record.
- Published supporting quick reference, asset inventory, template gallery, and compliance checklist.
- Corrected reference-template typography to the approved point-equivalent print scale.
- Added page-fill and flexible-space rules.
- Clarified SSS operational and HHH archival document archetypes.
- Revised teacher reference behavior to combine content or provide genuine notes space.
- Added accessible response-area expansion into remaining printable space.

## v0.9

- Locked CER, vocabulary, forms, rubrics, answer keys, accessibility, navigation, and print QA.

## v0.8

- Locked covers, image framing, source imagery, and selective game-asset reuse.

## v0.7

- Locked institutional identity, section icons, semantic markers, and publication marks.

## v0.6

- Locked explanatory visuals, maps, timelines, graphs, captions, and source status.

## v0.5

- Locked page components and response systems.
...
- Locked typography, grayscale, institutional colors, and icon family.

## v0.2

- Locked institutional brand architecture and canonical SAA meaning.
