# VISUAL_STYLE_GUIDE_v0.9

> **Repository Draft**  
> **Projects:** *Space Sprout Sleuth* (SSS) and *Hunger, Harvest, & History* (HHH)  
> **Status:** v0.9 — CER, Vocabulary, Forms, Rubrics, Answer Keys, Accessibility, Navigation, and Print QA  
> **Supersedes:** `VISUAL_STYLE_GUIDE_v0.8.md`  
...
> **Next planned revision:** v1.0 — Consolidation, production examples, reusable templates, audits, and final compliance checklist
...
| Current maturity | Institutional identity, typography, grayscale, accent palettes, page architecture, component systems, explanatory visuals, the SAA insignia direction, the TAA/SAA master strategy, section-icon vocabulary, semantic markers, and publication-status marks are locked; final insignia artwork, image reuse, covers, assessment, accessibility, and production systems remain in development |
...
Version 0.9 carries forward all approved v0.8 standards and locks the final specialized component systems needed before v1.0 consolidation.

Approved choices:

- **CER layout:** Three stacked boxes
- **Vocabulary treatment:** Term-definition table
- **Rubric format:** Analytic criteria grid
- **Teacher-answer treatment:** Dedicated answer-key blocks
- **Accessible variant:** Parallel accessible edition
- **Forms:** Standard square checkboxes, circular single-choice controls, and explicitly labeled confidence or rating scales
- **Navigation:** Running identity, section references, page number and total, and controlled continuation labels
- **Print production:** Grayscale, low-ink, laser, inkjet, photocopy, duplex, binding, punch-safety, and minimum-line testing required

The stacked CER selection intentionally gives Claim, Evidence, and Reasoning separate writing spaces. It is more visually explicit than the integrated-frame recommendation and is approved as the ordinary scaffold.

The grayscale preview was not recorded as viewed in the v0.9 decision note. The choices are approved, but completed templates still require grayscale and physical-print testing before v1.0.
...
- consolidated guide cleanup;
- final cross-reference audit;
- final insignia asset inventory;
...
- representative accessible template;
- grayscale and photocopy evidence;
- component decision tree;
- repository template package;
- full compliance checklist;
- deprecation guidance for older drafts and labs.

No additional major visual system is planned after v0.9.
...
| Accessible edition | Parallel accessible edition |
| Forms | Standardized print and digital controls |
| Navigation | Running identity and stable page references |
| Print QA | Required across grayscale, photocopy, duplex, binding, and low-ink output |

The grayscale preview was not recorded as viewed. Production testing remains required before v1.0.
...
- Locked three stacked CER boxes.
- Locked term-definition vocabulary tables.
- Standardized form controls, scales, and rankings.
- Locked analytic criteria rubrics.
- Locked dedicated answer-key blocks.
- Defined running navigation.
- Locked parallel accessible editions.
- Defined large-print and alternate-response behavior.
- Defined grayscale, printer, photocopy, duplex, binding, punch, low-ink, and QR testing.
- Added CSS tokens and specialized QA checklist.

## v0.8

- Locked Mission-Title Covers, image framing, caption bands, historical-photo treatment, and selective game-asset reuse.
...
- Locked explanatory diagrams, maps, timelines, graphs, captions, and source-status systems.

## v0.5

- Locked section headings, callouts, response areas, tables, teacher notes, and component geometry.

## v0.4

- Locked the Mission Title Block, continuation headers, grid, margins, density, and footer.

## v0.3

- Locked typography, grayscale, institutional palettes, and Phosphor icon treatment.

## v0.2

- Defined the SAA/TAA institutional architecture and moderate immersion.

## v0.1

- Established the shared professional, grayscale-first, diagram-led direction.
